    ...
    json_build_object(
        ...
        'meta', json_build_object(
            'profile', json_build_array(
                'https://build.fhir.org/ig/arkhn/arkhn-ig-osiris/StructureDefinition/radiotherapy-course-summary'
            )
        ),
        ...
        'extension', json_build_array(
            CASE WHEN coursert."extension_treatmentIntent" IS NOT NULL THEN json_build_object(
                'url', 'https://build.fhir.org/ig/arkhn/arkhn-ig-osiris/StructureDefinition/treatmentIntent',
            ...
            CASE WHEN coursert."extension_numberOfSessions" IS NOT NULL THEN json_build_object(
                'url', 'https://build.fhir.org/ig/arkhn/arkhn-ig-osiris/StructureDefinition/numberOfSessions',
            ...
            CASE
                WHEN
                    ...
                    THEN json_build_object(
                        'url',
                        'https://build.fhir.org/ig/arkhn/arkhn-ig-osiris/StructureDefinition/treatmentTerminationReason',
                        'valueCodeableConcept', json_build_object(
                            'coding', json_build_array(
                                json_build_object(
...
LEFT JOIN
    ...
    ON coursert."category_coding_code"::text = codeableconcept_category."code"
LEFT JOIN
    {{ ref('osiris_master_tab_Procedure_radiotherapy_codeableconcept') }}
