...
series_object AS (
            ...
            'extension', json_build_array( --global extension array
                CASE WHEN
                    ...
                    THEN json_build_object(
                        ...
                        'url', 'https://build.fhir.org/ig/arkhn/arkhn-ig-osiris/StructureDefinition/imaging-settings'
                    ) END,
                CASE WHEN
                    ...
                    THEN json_build_object(
                        ...
                        'url', 'https://build.fhir.org/ig/arkhn/arkhn-ig-osiris/StructureDefinition/series-weightheigt'
                    ) END
            ),
    ...
    LEFT JOIN
        ...
        ON imagingstudy."series_bodySite_code"::text = imagingstudy_codeableconcept_bodysite."code_dicom"
    LEFT JOIN
        instances_array
        ...
        json_build_object(
            ...
            'meta', json_build_object(
                'profile', json_build_array(
                    'https://build.fhir.org/ig/arkhn/arkhn-ig-osiris/StructureDefinition/onco-imagingstudy'
                )
            ),
            'status', 'available',
