    ...
    json_build_object(
        ...
        'meta', json_build_object(
            'profile', json_build_array(
                'http://fhir.arkhn.com/osiris/StructureDefinition/onco-patient'
            )
        ),
        'identifier',
        json_build_array(
        ...
        json_build_array(
            CASE
                WHEN patient."extension_origin_center_valuereference" IS NOT NULL
                    THEN json_build_object(
                        'url', 'http://fhir.arkhn.com/osiris/StructureDefinition/origin-center',
            ...
            CASE
                WHEN patient."extension_ethnicity_valueCodeableConcept_coding_code" IS NOT NULL
                    THEN json_build_object(
                        'url', 'http://fhir.arkhn.com/osiris/StructureDefinition/ethnicity',
